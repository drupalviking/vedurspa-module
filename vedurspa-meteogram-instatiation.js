/**
 * Created by drupalviking on 09/09/16.
 */
/**
...
Meteogram.prototype.windArrow = function (name) {
    ...
    level = jQuery.inArray(name, ['Calm', 'Light air', 'Light breeze', 'Gentle breeze', 'Moderate breeze',
...
Meteogram.prototype.getTitle = function () {
    return 'Veðurspá fyrir ' + this.xml.location.name;
};
...
Meteogram.prototype.getChartOptions = function () {
    ...
    return {
        ...
        credits: {
            text: 'Veðurspá frá <a href="http://vedur.is">Veðurstofu Íslands</a>',
...
Meteogram.prototype.parseYrData = function () {
    ...
    if (!xml || !xml.forecast) {
        jQuery('#loading').html('<i class="fa fa-frown-o"></i> Failed loading data, please try again later');
        return;
    }
    ...
    jQuery.each(xml.forecast.tabular.time, function (i, time) {
